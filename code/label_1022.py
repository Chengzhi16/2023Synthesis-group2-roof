...
parser.add_argument('--path', '-p', type=str, default='denhaag_small_lod2.geojson', help='An optional path argument')
...
import pandas as pd
features = pd.read_csv("1022_label_feature/Denhaag_small_features.csv")
