...
cm=cityjson.load('rotterdam_c_22.json')
...
for index, row in gdf.iterrows():
    ...
    if row['N_direct'] == 0:
        count += 1
gdf.to_csv('rotterdam_N.csv')

print("there are ", count, "not intersected buildings")

# import pandas as pd
# df1=pd.read_csv("denhaag_small_lod2.csv")
# df2=pd.read_csv("denhaag_N.csv")
#
